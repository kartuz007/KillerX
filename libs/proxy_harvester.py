...
''')#line:54
    ...
    O000OOOOOO0O0O0OO =input (Fore .LIGHTWHITE_EX +"Choose Proxy Type: ")#line:56
    ...
    elif (O000OOOOOO0O0O0OO =="0"):
        print("\nQuitting...")
        sleep(1)
        exit()
    else :#line:89
        print (f"No Option Found -> '{O000OOOOOO0O0O0OO}' ")#line:90
if __name__ =="__main__":#line:91
    try :#line:92
        find_proxies ()#line:93
        print("[*] All Proxy's Successfully Generated And Saved To File! Now you can use them to report")#line:94
    except KeyboardInterrupt :#line:95
        print ("\n\n"+Fore .RED +"[*] KillerX is closing!")#line:96
